...
int check_avl(const binary_tree_t *t);
 ...
 *
 * Return: 1 if t is a valid AVL Tree, and 0 otherwise.
 */
int check_avl(const binary_tree_t *t)
{
	if (t == NULL)
 ...
 *
 * Return: If t is NULL, your function must return 0, else return height.
 */
size_t calculate_height(const binary_tree_t *t)
{
	if (t)
